            ...
            >
              ...
              <CardContent className="p-0 text-[#8b8f8f]">
                <div className="text-sm">
                  <div className="flex max-h-[25rem] flex-col space-y-5 overflow-y-auto">
                    <p>
                      Tech Stack: React.js, Next.js 14, Typescript, Javascript,
                      Azure, Postgresql, D3.js
                    </p>
                    <ul className="list-disc space-y-2 pl-3">
                      <li>
                        Analytical charting library that avoids abstraction and
                ...
                <div className="mx-auto flex w-full flex-row items-center justify-center space-x-3 pt-8 hover:bg-none">
                  <Button className="w-1/4  bg-[#454166] shadow-lg hover:bg-[#454166]">
                    Visit
                  </Button>
                  <Button className="first-letter: w-1/4 bg-[#454166] shadow-lg hover:bg-[#454166]">
                    <Image
                      className="b"
                      src="/githublight.svg"
                      alt={"GitHub"}
