                ...
                >
                    <div className="flex flex-col items-center space-y-1">
                        ...
                        <p className="flex max-w-[35rem] items-center justify-center pt-5 text-center text-xl text-[#d5d5d8]">
                            Software developer, SaaS, full-stack and business
                            solutions. Passionate about technology and its
                            impact on the world.
                        </p>
                    </div>
                </section>
                                    ...
                                    <div className="flex flex-col space-y-5">
                                        ...
                                        <ul className="list-disc space-y-2 pl-4">
                                            ...
                                            <li>
                                                ...
                                                instructions with an intuitive
                                                interface
                                            </li>
                                            <li>
                                                Includes a fully-functional
                                                admin dashboard for easy
