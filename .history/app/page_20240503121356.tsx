        ...
        >
          <div className="flex flex-row space-x-10">
            ...
            <Card
              onMouseEnter={() => setIsHoveredPair1(true)}
              onMouseLeave={() => setIsHoveredPair1(false)}
              className={`w-xl relative max-w-xl shrink-[2] grow-[2] rounded-lg border border-[#60647872] bg-opacity-10  bg-gradient-to-b  from-[#35374366] to-[#24212b65] p-6 
              ${isHoveredPair1 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
            >
              ...
              <CardContent className="text-[#8b8f8f]">
                <CardDescription className="">
                  <div className="w-xl">
                    <p>Tech Stack: Next.js 14, Typescript, Firebase, Stripe</p>
                    <p>
                      Analytical charting libraryAnalytical charting
                      libraryAnalytical charting libraryAnalytical charting
                      libraryAnalytical charting libraryAnalytical charting
                      libraryAnalytical charting libraryAnalytical charting
                      libraryAnalytical chAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      ...
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryAnalytical charting libraryAnalytical
                      charting libraryarting libraryAnalytical charting
                      libraryAnalytical charting libraryAnalytical charting
                      libraryAnalytical charting libraryAnalytical charting
                      libraryAnalytical charting library
                    </p>
                  </div>
                </CardDescription>
              </CardContent>
              <div className="h-7 w-11 flex-none">
                <Button>Visit</Button>
              </div>
            </Card>
          </div>
