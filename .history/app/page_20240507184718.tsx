      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        <section id="about_me" className="container mx-auto px-4 pb-10 sm:pb-32 pt-6 sm:pt-14">
          <div className="flex flex-col items-center space-y-1">
            ...
            <p className="flex justify-center items-center text-center max-w-[35rem] text-xl pt-5 text-[#d9d9db]">Software developer, Saas and business solutions. Passionate about technology and its impact on the world</p>
          </div>
        </section>
        {/* Desktop view */}
