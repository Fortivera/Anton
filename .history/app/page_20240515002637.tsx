  ...
  return (
    <div className="flex min-h-screen w-full flex-col text-base text-white">
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        <section
          id="about_me"
          className="container mx-auto px-4 pb-10 pt-6 sm:pb-20 sm:pt-7"
        >
          <div className="flex flex-col items-center space-y-1">
            <p className="flex flex-col items-center justify-center bg-gradient-to-b from-[#ffffff] to-[#cccccc] bg-clip-text pb-5 pt-5 text-center text-5xl font-medium text-transparent sm:flex-row sm:pt-10">
              Anton Strelkovskyy
            </p>
            ...
            <div className="flex flex-col items-center justify-center py-3">
              ...
              <p className="flex max-w-[30rem] items-center justify-center text-center text-lg text-neutral-400">
                ...
                <br /> creating elegant solutions in the process.&rdquo;
              </p>
            </div>
            <p className="flex max-w-[35rem] items-center justify-center pt-5 text-center text-xl text-[#d5d5d8]">
              Software developer, SaaS, full-stack and business solutions.
                ...
                <div className="text-base">
                  <div className="flex flex-col space-y-5">
                    ...
                    <ul className="list-disc space-y-2 pl-4">
                      ...
                      <li>
                        Features beginner-friendly instructions with an
                        intuitive interface
                      </li>
                      <li>
                        Includes a fully-functional admin dashboard for easy
                        management of recipes and images
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mx-auto flex w-full items-center justify-center pt-8 hover:bg-none">
                  <div className="flex w-2/3 items-center justify-center">
                    <VisitButton
                      key={"btn6"}
                      buttonId={"btn6"}
                      targetUrl={"https://www.graphalytics.co/"}
                    ></VisitButton>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="mx-auto flex w-full flex-row items-center justify-center space-x-5 pt-8 hover:bg-none">
                  <div className="flex w-2/5 items-center justify-center">
                    <VisitButton
                      key={"btn7"}
                      buttonId={"btn7"}
                      targetUrl={"https://yourestate.vercel.app/"}
                    ></VisitButton>
                  </div>
                  <div className="flex w-2/5 items-center justify-center">
                    <GitButton
                      key={"btn8"}
                      buttonId={"btn8"}
                      targetUrl={"https://github.com/Fortivera/yourestate"}
                    ></GitButton>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="mx-auto flex w-full flex-row items-center justify-center space-x-5 pt-8 hover:bg-none">
                  <div className="flex w-2/5 items-center justify-center">
                    <VisitButton
                      key={"btn6"}
                      buttonId={"btn6"}
                      targetUrl={"https://justcook.fly.dev/"}
                    ></VisitButton>
                  </div>
                  <div className="flex w-2/5 items-center justify-center">
                    <GitButton
                      key={"btn9"}
                      buttonId={"btn9"}
                      targetUrl={"https://github.com/Fortivera/Recipe_webapp"}
                    ></GitButton>
                  </div>
                </div>
              </CardContent>
