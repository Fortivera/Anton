      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        ...
        <section className="hidden sm:grid grid-cols-1 gap-8 justify-items-center py-12" id="projects">
          <div className="flex flex-row space-x-10">
            <Card className="max-w-[51rem] relative p-6 border rounded-lg bg-opacity-10 bg-[#9d94e9] hover:bg-[#24242779] border-[#60647872] hover:border-[#21222972] bg-gradient-to-b from-[#35374366] to-[#24212b65]">
