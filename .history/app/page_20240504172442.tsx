...
export default function Home() {
  const [isSubmittingButton1, setIsSubmittingButton1] = useState(false);
  const [isSubmittingButton2, setIsSubmittingButton2] = useState(false);
  const [isSubmittingButton3, setIsSubmittingButton3] = useState(false);
            ...
            >
              ...
              <div className="flex justify-center items-center w-full mx-auto pt-8 hover:bg-none">
                <Link className="flex justify-center items-center w-2/3" href="https://www.graphalytics.co/">
                  <Button
                    onClick={() => setIsSubmittingButton1(true)}
                    type="button"
                    disabled={isSubmittingButton1}
                    className="w-full hover:bg-[#454166] bg-[#454166] shadow-lg">
                    {isSubmittingButton1 && <Loader2 className="inline mr-2 h-4 w-4 animate-spin" />}
                    {isSubmittingButton1 ?
                      <p>Please wait</p>
                      :
                      <p>Visit</p>
            ...
            >
              ...
              <div className="flex flex-row justify-center items-center w-full space-x-5 mx-auto pt-8 hover:bg-none">
                ...
                <Link className="flex justify-center items-center w-1/3" href="https://github.com/Fortivera/PropertyNextjs">
                  <Button
                    onClick={() => setIsSubmittingButton2(true)}
                    type="button"
