      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-row space-x-10">
            <Card className="relative h-[24rem] max-w-lg rounded-lg border border-[#60647872] bg-opacity-10 bg-gradient-to-b  from-[#35374366] to-[#24212b65] p-6 hover:border-[#8686872c] hover:bg-[#373757] hover:bg-gradient-to-b hover:from-[#42424966] hover:to-[#2d2c3165]">
