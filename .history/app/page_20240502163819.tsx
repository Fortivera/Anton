      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        ...
        <section className="hidden sm:grid grid-cols-1 gap-8 justify-items-center py-12" id="projects">
          <div className="flex flex-row space-x-10">
            <Card className="max-w-lg h-[24rem] relative p-6 border rounded-lg bg-opacity-10 hover:bg-[#373757]  hover:border-[#8686872c] border-[#60647872] hover:bg-gradient-to-b hover:from-[#42424966] hover:to-[#2d2c3165] bg-gradient-to-b from-[#35374366] to-[#24212b65]">
