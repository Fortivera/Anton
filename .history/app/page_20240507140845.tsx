            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-col items-center space-y-1">
                        ...
                        >
                            &quot;Problems exist to practise critical thinking,
                            creating elegant solutions in the process.&quot;
                        </p>
                                        ...
                                        <div className="flex flex-col space-y-5">
                                            ...
                                            <ul className="list-disc space-y-2 pl-3">
                                                ...
                                                <li>
                                                    ...
                                                    chart types, seamlessly
                                                    integrable into an analytics
                                                    dashboard
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            >
                                ...
                                <CardContent className="text-[#8b8f8f]">
                                    <div className="text-base">
                                        <div className="flex flex-col space-y-5">
                                            <p>
                                                Tech Stack: Typescript, C#,
                                                Next.js 14, Azure, D3.js, SQL
                                            </p>
                                            <ul className="list-disc space-y-2 pl-3">
                                                <li>
                                                    A modular real estate
