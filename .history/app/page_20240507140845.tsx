  ...
  return (
    <div className="min-h-screen w-full flex flex-col text-white text-base">
      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        ...
        {/* Desktop view */}
        <section className="grid grid-cols-1 justify-items-center py-12" id="projects">
          <div className="flex items-center justify-start w-full text-3xl pb-8">Explore my work</div>
          <div className="hidden sm:grid grid-cols-1 gap-20 justify-items-center ">
            <div className="mt-0 flex flex-col space-y-5 xl:space-y-0 xl:flex-row xl:space-x-10">
              <Card
