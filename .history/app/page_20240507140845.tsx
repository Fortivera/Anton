      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-col items-center space-y-1">
            <p className="flex flex-col items-center justify-center pb-5 pt-5 text-center text-4xl font-medium sm:flex-row sm:pt-10">
              Anton Strelkovkyy
            </p>
            ...
            <p
              className={
                "text flex max-w-[30rem] items-center justify-center text-center text-lg text-neutral-400"
              }
            >
              &quot;Problems exist to practise critical thinking, creating
              elegant solutions in the process.&quot;
            </p>
            <p className="flex max-w-[35rem] items-center justify-center pt-5 text-center text-xl">
        ...
        {/* Desktop view */}
        <section
          className="grid grid-cols-1 justify-items-center py-12"
          id="projects"
        >
          <div className="flex w-full items-center justify-start pb-8 text-3xl">
            Explore my work
          </div>
          <div className="hidden grid-cols-1 justify-items-center gap-20 sm:grid ">
            <div className="mt-0 flex flex-col space-y-5 xl:flex-row xl:space-x-10 xl:space-y-0">
              <Card
                  ...
                  <div className="text-base">
                    <div className="flex flex-col space-y-5">
                      ...
                      <ul className="list-disc space-y-2 pl-3">
                        <li>
                          A charting library that minimizes abstraction,
                          empowering users with full control over their code
                        </li>
                        <li>
                          Designed for users seeking a dynamic and
                          high-performance charting solution
                        </li>
                        <li>
                          Includes the most popular chart types, seamlessly
                          integrable into an analytics dashboard
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              >
                ...
                <CardContent className="text-[#8b8f8f]">
                  <div className="text-base">
                    <div className="flex flex-col space-y-5">
                      <p>
                        Tech Stack: Typescript, C#, Next.js 14, Azure, D3.js,
                        SQL
                      </p>
                      <ul className="list-disc space-y-2 pl-3">
                        <li>
                          A modular real estate solution that simplifies
                          property management
                        </li>
                        <li>
                        ...
                        <li>
                          Scalable and user-friendly, suitable for property
                  ...
                  <div className="text-base">
                    <div className="flex flex-col space-y-5">
                      ...
                      <ul className="list-disc space-y-2 pl-3">
                        ...
                        <li>
                          Features easy-to-follow instructions and a
