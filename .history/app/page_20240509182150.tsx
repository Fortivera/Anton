      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-col items-center space-y-1">
            <p className="flex flex-col items-center justify-center bg-gradient-to-b from-[#dddddd] to-[#838383] bg-clip-text pb-5 pt-5 text-center text-4xl text-4xl font-medium text-transparent sm:flex-row sm:pt-10">
              Anton Strelkovkyy
            </p>
