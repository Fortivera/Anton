            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10 ">
                        <Card className="relative h-[24rem] max-w-lg rounded-lg border border-[#ffffff33] bg-[#9d94e9cc] bg-opacity-20 bg-gradient-to-b from-[#35374399] to-[#24212b99] p-4 shadow-lg backdrop-blur-lg">
