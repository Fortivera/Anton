            ...
            >
              ...
              <CardContent className="text-[#8b8f8f] p-0">
                <div className="text-sm">
                  <div className="flex flex-col space-y-5 overflow-y-auto max-h-[25rem]">
                    <p>
                      Tech Stack: React.js, Next.js 14, Typescript, Javascript, Azure, Postgresql, D3.js
                    </p>
                    <ul className="list-disc pl-3 space-y-2">
                      <li>Analytical charting library that avoids abstraction and gives ownership of the code</li>
                      <li>Targets the users that need a dynamic and performant charting solution</li>
                ...
                <div className="flex flex-row justify-center items-center w-full mx-auto pt-8 hover:bg-none space-x-3">
                  <Button className="w-1/2  hover:bg-[#454166] bg-[#454166] shadow-lg">Visit</Button >
                  <Button className="w-1/2 first-letter: hover:bg-[#454166] bg-[#454166] shadow-lg">
                    <Image className="b" src="/githublight.svg" alt={"GitHub"} width={24} height={24} />
                  </Button >
                </div>
              </CardContent>
            </Card>
