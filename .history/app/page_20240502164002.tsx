            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10">
                        ...
                        <Card className="relative max-w-lg rounded-lg border border-[#60647872] bg-[#9d94e9] bg-opacity-10 bg-gradient-to-b from-[#35374366] to-[#24212b65] p-6 hover:bg-[#35353b3c]">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold text-[#D1D1D2]">
                                    Details
                                </CardTitle>
