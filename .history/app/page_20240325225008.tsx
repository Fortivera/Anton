...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col text-white text-base">
      <Header />
      <main className="flex flex-col bg-[#282828] w-full mx-auto p-6 flex-grow">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center py-12" id="projects">
          <Card className="max-w-lg relative p-6 border rounded-lg bg-opacity-10 bg-[#9d94e9] border-[#60647872] bg-gradient-to-b from-[#353743] to-[#24212b65]">
            <CardHeader>
