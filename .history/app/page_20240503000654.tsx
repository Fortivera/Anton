...
export default function Home() {
  const [hoverPair1, setHoverPair1] = useState(false);
  const [hoverPair2, setHoverPair2] = useState(false);
  const [hoverPair3, setHoverPair3] = useState(false);
  return (
        ...
        >
          <div className="flex flex-row space-x-10">
            ...
            <Card
              ...
              ${isHovered1 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
            >
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-[#D1D1D2]">
                  Details
          ...
          <div className="flex flex-col space-x-10 sm:flex-row">
            <Card
              ...
              className={`relative max-w-lg rounded-lg border border-[#60647872] bg-opacity-10  bg-gradient-to-b  from-[#35374366] to-[#24212b65] p-6 
              ${isHovered ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
            >
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-[#D1D1D2]">
                  YourEstate
