  ...
  return (
    <div className="min-h-screen w-full flex flex-col text-white text-base">
      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        <section id="about_me" className="container mx-auto px-1">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="flex justify-center items-center text-center w-[30rem] text-xl">Software developer, Saas and business solutions. Passionate about technology and its impact on the world</p>
          </div>
        </section>
        {/* Desktop view */}
