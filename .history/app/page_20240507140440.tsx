  ...
  return (
    <div className="min-h-screen w-full flex flex-col text-white text-base">
      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        ...
        {/* Desktop view */}
        <section className="hidden sm:grid grid-cols-1 gap-20 justify-items-center py-12" id="projects">
          <div className="my-0">Expore my work</div>
          <div className="hidden sm:grid grid-cols-1 gap-20 justify-items-center py-12">
