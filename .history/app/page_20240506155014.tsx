      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        <section id="about_me" className="container mx-auto px-4">
          <div className="flex flex-col items-center space-y-1">
            <p className={cn("text-4xl pt-10 pb-5 font-medium", figtree.className)}>Anton Strelkovkyy</p>
            {/* <div className="flex justify-center items-center rounded-full border border-white h-20 w-20">pic</div> */}
            <SocialLinks />
            <p className={cn("flex justify-center items-center text-center w-[30rem] text-lg text-neutral-400 text", figtree.className)}>&quot;Problems exist to practise critical thinking, creating elegant solutions in the process.&quot;</p>
