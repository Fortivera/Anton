            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10 ">
                        <Card className="relative h-[24rem] max-w-lg rounded-lg border border-[#ffffff35] bg-opacity-20 bg-gradient-to-b from-[#ffffff1a] to-[#ffffff10] p-4 text-white shadow-md backdrop-blur-md">
