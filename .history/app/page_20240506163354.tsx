              ...
              <CardContent className="text-[#8b8f8f]">
                <div className="text-base">
                  <div className="flex flex-col space-y-5">
                    ...
                    <ul className="list-disc space-y-2 pl-3">
                      <li>
                        Modular real estate solution for keeping track of
                        properties
                      </li>
                      <li>
                        Created to have data analytics and visualization in one
                        place
                      </li>
                      <li>
                        Scalable and easy to use for property owners of any
                        level
                      </li>
                    </ul>
                  </div>
