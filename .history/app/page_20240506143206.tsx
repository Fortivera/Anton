            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                <section id="about_me" className="container mx-auto px-4">
                    <div className="flex flex-col items-center space-y-1">
                        <p className="py-2 pt-10 text-3xl">Anton Strelkovkyy</p>
                        {/* <div className="flex justify-center items-center rounded-full border border-white h-20 w-20">pic</div> */}
                        <SocialLinks />
                        <p className="flex w-[30rem] items-center justify-center text-center text-xl text-neutral-400">
                            &quot;Problems exist to practise critical thinking,
                            creating elegant solutions in the process.&quot;
                        </p>
                        <p className="flex w-[30rem] items-center justify-center pt-5 text-center text-2xl">
