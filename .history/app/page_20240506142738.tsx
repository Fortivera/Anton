      ...
      <main className="flex flex-col bg-[#131313] w-full mx-auto p-6 flex-grow">
        <section id="about_me" className="container mx-auto px-4">
          <div className="flex flex-col items-center space-y-4">
            ...
            <SocialLinks />
            <p className="flex justify-center items-center text-center w-[30rem] text-xl text-[#b7bac1]">&quot;Problems exist to practise critical thinking, creating elegant solutions in the process.&quot;</p>
