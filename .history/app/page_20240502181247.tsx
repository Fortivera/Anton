      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-row space-x-10">
            <Card className="relative h-[24rem] w-full max-w-[51rem] rounded-lg border border-[#8686872c] bg-[#373757] bg-opacity-10 bg-gradient-to-b from-[#42424966] to-[#2d2c3165] p-6">
