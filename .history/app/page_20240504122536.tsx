          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <CardContent className="text-[#8b8f8f] p-0">
                ...
                <div className="flex flex-col justify-center items-center w-full mx-auto pt-8 hover:bg-none">
                  <Button className="w-2/3 hover:bg-[#454166] bg-[#454166] shadow-lg">Github</Button >
                  <Button className="w-2/3 hover:bg-[#454166] bg-[#454166] shadow-lg">Visit</Button >
                </div>
              </CardContent>
            </Card>
