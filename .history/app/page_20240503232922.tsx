        ...
        <section className="hidden customdesktop:grid grid-cols-1 gap-8 justify-items-center py-12 space-y-16" id="projects">
          <div className="flex flex-row space-x-10">
            <Card
              ...
              className={`max-w-[47rem] max-h-[354px] grow shrink relative p-6 border rounded-lg bg-opacity-10  border-[#60647872]  bg-gradient-to-b from-[#35374366] to-[#24212b65] 
            ...
            <Card
              onMouseEnter={() => setIsHoveredPair1(true)}
              onMouseLeave={() => setIsHoveredPair1(false)}
              className={`max-w-xl grow-[1.5] shrink-[1.5] relative p-6 border rounded-lg bg-opacity-10  border-[#60647872]  bg-gradient-to-b from-[#35374366] to-[#24212b65] 
              ${isHoveredPair1 ? "bg-[#24242779] border-[#21222972]" : "bg-[#9d94e9]"}`}
            >
