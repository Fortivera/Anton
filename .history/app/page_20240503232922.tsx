            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10">
                        <Card
                            ...
                            className={`relative max-h-[354px] max-w-[47rem] shrink grow rounded-lg border border-[#60647872] bg-opacity-10  bg-gradient-to-b  from-[#35374366] to-[#24212b65] p-6 
              ${isHoveredPair1 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                        ...
                        <Card
                            onMouseEnter={() => setIsHoveredPair1(true)}
                            onMouseLeave={() => setIsHoveredPair1(false)}
                            className={`relative max-w-xl shrink-[1.5] grow-[1.5] rounded-lg border border-[#60647872] bg-opacity-10  bg-gradient-to-b  from-[#35374366] to-[#24212b65] p-6 
              ${isHoveredPair1 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                        >
              ...
              ${isHoveredPair3 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                ...
                <section
                    className="customdesktop:hidden hidden grid-cols-1 justify-items-center gap-8 space-y-16 py-12 sm:grid"
                    id="projects"
                >
                    <div>
                        <Card
              ...
              ${isHoveredPair1 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                        >
                            ...
                            <CardContent className="text-[#8b8f8f]">
                                <div className="pverflow-y-auto flex flex-col space-y-5 text-base">
                                    <p>
                                        Tech Stack: Next.js 14, Typescript,
                                        Firebase, Stripe, D3.js
                                    </p>
                                    <ul className="list-disc space-y-2 pl-3">
                                        ...
                                        <li>
                                            Has the most used chart types that
                                            can be colaged into a dashboard
                                        </li>
                                    </ul>
                                </div>
                            </CardContent>
