        ...
        >
          <div className="flex flex-row space-x-10">
            <Card
              ...
              className={`relative max-w-lg rounded-lg border bg-opacity-10 p-6 ${isHovered ? "hover:border-[#21222972] hover:bg-[#24242779]" : "border-[#60647872] bg-[#9d94e9]"}      bg-gradient-to-b from-[#35374366] to-[#24212b65]`}
            >
            ...
            <Card
              onMouseEnter={() => setIsHovered(true)}
              onMouseLeave={() => setIsHovered(false)}
              className={`relative max-w-lg rounded-lg border bg-opacity-10 p-6 ${isHovered ? "bg-[#24242779]" : "bg-[#9d94e9]"} border-[#60647872] bg-gradient-to-b from-[#35374366] to-[#24212b65] hover:border-[#21222972] hover:bg-[#24242779]`}
            >
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-[#D1D1D2]">
                  Details
