          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <CardContent className="text-[#8b8f8f] p-0">
                ...
                <div className="flex flex-row justify-center items-center w-full mx-auto pt-8 hover:bg-none">
                  ...
                  <Button className=" first-letter: hover:bg-[#454166] bg-[#454166] shadow-lg">
                    <Image className="bg-slate-300" src="/github.svg" alt={"GitHub"} width={24} height={24} />
                  </Button >
                </div>
              </CardContent>
            </Card>
