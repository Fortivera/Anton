            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10 ">
                        <Card className="relative h-[24rem] max-w-lg rounded-lg border border-[#ffffff1a] bg-opacity-10 bg-gradient-to-b from-[#ffffff0a] to-[#ffffff05] p-4 shadow-sm backdrop-blur-sm">
