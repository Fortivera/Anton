              ...
              <CardContent className="text-[#8b8f8f]">
                <div className="text-base">
                  <div className="flex flex-col space-y-5">
                    <p>
                      Tech Stack: Typescript, Next.js 14, Firebase, Stripe, D3.js
                    </p>
                    <ul className="list-disc pl-3 space-y-2">
                      ...
                      <li>Includes the most popular chart types, seamlessly integrable into a comprehensive dashboard</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
