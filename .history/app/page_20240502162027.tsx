            ...
            <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
                ...
                >
                    <div className="flex flex-row space-x-10 ">
                        <Card className="relative h-[24rem] max-w-lg rounded-lg border border-[#60647872] bg-[rgb(35,35,36)] bg-opacity-10 bg-gradient-to-b from-[#3c3d4766] to-[#29272e65] p-6">
