      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-col items-center space-y-1">
            <p className="flex flex-col items-center justify-center pb-5 pt-5 text-center text-4xl font-medium text-[#D1D1D2] sm:flex-row sm:pt-10">
              Anton Strelkovkyy
            </p>
            ...
            <p className="flex max-w-[35rem] items-center justify-center pt-5 text-center text-xl text-neutral-300">
