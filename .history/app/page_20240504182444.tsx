...
export default function Home() {
  ...
  const [buttonLoading, setButtonLoading] =
    useState<ButtonStates>(initialState);
              ...
              <div className="mx-auto flex w-full items-center justify-center pt-8 hover:bg-none">
                ...
                >
                  ...
                  >
                    ...
                    {buttonLoading.btn1 ? <p>Please wait</p> : <p>Visit</p>}
                  </Button>
                </Link>
              </div>
            </Card>
              ...
              <div className="mx-auto flex w-full flex-row items-center justify-center space-x-5 pt-8 hover:bg-none">
                ...
                >
                  ...
                  >
                    ...
                    {buttonLoading.btn2 ? <p>Please wait</p> : <p>Visit</p>}
                  </Button>
                </Link>
                <Link
                  className="flex w-1/3 items-center justify-center"
              ...
              <div className="mx-auto flex w-full flex-row items-center justify-center space-x-5 pt-8 hover:bg-none">
                ...
                >
                  ...
                  >
                    ...
                    {buttonLoading.btn4 ? <p>Please wait</p> : <p>Visit</p>}
                  </Button>
                </Link>
                <Link
                  className="flex w-1/3 items-center justify-center"
