    ...
    <div className="flex min-h-screen w-full flex-col text-base text-white">
      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          ...
          <div className="flex flex-col space-x-10 overflow-y-auto sm:flex-row">
            <Card className="relative h-96 max-w-lg rounded-lg border border-[#60647872] bg-[#9d94e9] bg-opacity-10 bg-gradient-to-b from-[#35374366] to-[#24212b65] p-6">
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-[#D1D1D2]">
                  Graphalytics
                </CardTitle>
