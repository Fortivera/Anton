                ...
                <CardDescription className="text-base">
                  <div className="flex flex-col space-y-5 pverflow-y-auto">
                    ...
                    <ul className="list-disc pl-3 space-y-2">
                      ...
                      <li>Has the most used chart types that can be colaged into a dashboard hkjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj</li>
                    </ul>
                  </div>
                </CardDescription>
              </CardContent>
