              ...
              ${isHoveredPair3 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                ...
                >
                    <div className="flex flex-col">
                        <Card
                            className={`relative rounded-lg border border-[#60647872] bg-[#9d94e9] bg-opacity-10 bg-gradient-to-b  from-[#35374366] to-[#24212b65] px-3 hover:border-[#21222972] hover:bg-[#24242779]
              `}
                        >
                            <CardHeader className="pt-0">
                                <CardTitle className="pt-0 text-lg font-semibold text-[#D1D1D2]">
                            ...
                            <CardContent className="text-[#8b8f8f]">
                                <div className="text-sm">
                                    <div className="flex max-h-40 flex-col space-y-5 overflow-y-auto">
                                        <p>
                                            Tech Stack: Next.js 14, Typescript,
                                            Firebase, Stripe, D3.js
                                        </p>
                                ...
                                <div className="mx-auto flex w-full items-center justify-center pt-4 hover:bg-none">
                                    <Button className="w-2/3 bg-[#454166] shadow-lg hover:bg-[#454166]">
                                        Visit
                                    </Button>
                                </div>
