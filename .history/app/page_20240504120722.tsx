              ...
              ${isHoveredPair3 ? "border-[#21222972] bg-[#24242779]" : "bg-[#9d94e9]"}`}
                ...
                >
                    <div className="flex flex-col">
                        <Card
                            className={`relative max-h-96 max-w-[51rem] rounded-lg border border-[#60647872] bg-[#9d94e9] bg-opacity-10 bg-gradient-to-b from-[#35374366] to-[#24212b65]  p-6 hover:border-[#21222972] hover:bg-[#24242779] xl:max-h-none xl:max-w-lg
              `}
                        >
                            <CardHeader className="pt-0">
                                <CardTitle className="pt-0 text-lg font-semibold text-[#D1D1D2]">
