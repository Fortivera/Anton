        ...
        <section id="about_me" className="container mx-auto px-4 pb-10 sm:pb-32 pt-6 sm:pt-14">
          <div className="flex flex-col items-center space-y-1">
            ...
            <div className="flex flex-col justify-center items-center py-3">
              ...
              <SocialLinks />
              <p className={"flex justify-center items-center text-center max-w-[30rem] text-lg text-neutral-400 text"}>&quot;Problems exist to practise our thinking, creating elegant solutions in the process.&quot;</p>
            </div>
