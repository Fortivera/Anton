      ...
      <main className="mx-auto flex w-full flex-grow flex-col bg-[#131313] p-6">
        ...
        >
          <div className="flex flex-col items-center space-y-1">
            <p className="flex flex-col items-center justify-center pb-5 pt-5 text-center text-4xl font-medium text-[#d9d9db] sm:flex-row sm:pt-10">
              Anton Strelkovkyy
            </p>
            <span className="from-foreground to-foreground-light block bg-gradient-to-b bg-clip-text text-[#F4FFFA00]">
              Build asdfasdfin a weekend
            </span>
