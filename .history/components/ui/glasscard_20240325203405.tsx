...
const GlassyComponent: React.FC<GlassyComponentProps> = (props) => {
  return (
    <div className="relative rounded-lg border-2 border-[#46465666] bg-opacity-20 bg-gradient-to-b from-[#36364466] to-[#28242f65] p-6 shadow-inner shadow-[#36364466] backdrop-blur-md">
