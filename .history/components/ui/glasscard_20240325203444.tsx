...
const GlassyComponent: React.FC<GlassyComponentProps> = (props) => {
    return (
        <div className="relative p-6 border-2 shadow-inner shadow-sm shadow-[#9a9abd66] rounded-lg backdrop-blur-md bg-opacity-20 border-[#46465666] bg-gradient-to-b from-[#36364466] to-[#28242f65]">
